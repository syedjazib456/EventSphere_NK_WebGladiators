    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaGallery", x => x.MediaId);
                    table.ForeignKey(
                        name: "FK_MediaGallery_AspNetUsers_UploaderId",
                        column: x => x.UploaderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MediaGallery_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaGallery_EventId",
                table: "MediaGallery",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaGallery_UploaderId",
                table: "MediaGallery",
                column: "UploaderId");
